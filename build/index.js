(function (global, factory) {
  ...
  var build$2 = build$3.exports;

  var hasRequiredBuild$1;

  function requireBuild$1 () {
  	if (hasRequiredBuild$1) return build$3.exports;
  	hasRequiredBuild$1 = 1;
  	(function (module, exports) {
  		(function (global, factory) {
  		  factory(exports) ;
  		})(build$2, (function (exports) {
  		  ...
  		  function requireShared () {
  		  	if (hasRequiredShared) return shared$1.exports;
  		  	hasRequiredShared = 1;
  		  	(function (module, exports) {
  		  		(function (global, factory) {
  		  		  factory(exports) ;
  		  ...
  		  (function (BufferUsage) {
  		      BufferUsage[BufferUsage["Storage"] = 0] = "Storage";
  		      BufferUsage[BufferUsage["Uniform"] = 1] = "Uniform";
  		      BufferUsage[BufferUsage["Vertex"] = 2] = "Vertex";
  		      BufferUsage[BufferUsage["Index"] = 3] = "Index";
  		      BufferUsage[BufferUsage["CopySource"] = 4] = "CopySource";
  		      BufferUsage[BufferUsage["CopyDestination"] = 5] = "CopyDestination";
  		  ...
  		  class Renderer {
  		      ...
  		      debug;
  		      constructor(options) {
  		          this.clearColor = options.clearColor ?? sharedExports.Color.BLACK;
  		  ...
  		  var BindGroupIndex;
  		  (function (BindGroupIndex) {
  		      BindGroupIndex[BindGroupIndex["Basic"] = 0] = "Basic";
  		      BindGroupIndex[BindGroupIndex["Material"] = 1] = "Material";
  		      BindGroupIndex[BindGroupIndex["Instanced"] = 2] = "Instanced";
  		  ...
  		  class Buffer {
  		      ...
  		      constructor(options) {
  		          ...
  		          if (options.data !== undefined) {
  		              sharedExports.Data.assert(this.size === options.data.byteLength, [
  		  ...
  		  class WebGpuBuffer extends Buffer {
  		      ...
  		      writeElements(sourceData, bufferIndexOffset = 0, sourceIndexOffset = 0, sourceSize = sourceData.length) {
  		      ...
  		      writeBytes(sourceData, bufferOffset = 0, sourceOffset = 0, sourceSize = sourceData.byteLength) {
  		          this.renderer.device.queue.writeBuffer(this.handle, bufferOffset, sourceData, sourceOffset, sourceSize);
  		      }
  		      static translateSingleBufferUsage(usage) {
  		          switch (usage) {
  		      ...
  		      static translateBufferUsage(usages) {
  		  ...
  		  class WebGpuTexture extends Texture {
  		      ...
  		      constructor(options) {
  		          ...
  		          if (options.source instanceof ImageBitmap) {
  		              options.renderer.device.queue.copyExternalImageToTexture({ source: options.source, flipY: true }, { texture: this.handle }, { width: this.width, height: this.height });
  		          }
  		      }
  		  }

  		  class WebGpuMaterial extends Material {
  		      bindGroup;
  		      constructor(options) {
  		          super(options);
  		          ...
  		          if (options.textures !== undefined) {
  		              entries.push(...options.textures.map((texture, index) => {
  		                  sharedExports.Data.assert(texture instanceof WebGpuTexture);
  		                  return {
  		                      binding: 1 + index,
  		  ...
  		  let InstanceManager$1 = class InstanceManager {
  		      pipeline;
  		      _model;
  		      _instances;
  		      constructor(options) {
  		  ...
  		  class WebGpuInstanceManager extends InstanceManager$1 {
  		      renderer;
  		      _data;
  		      _bindGroup;
  		      _buffer;
  		      ...
  		      pack() {
  		          ...
  		          sharedExports.Data.assert(this._data.byteLength < maximumUniformBufferSize, [
  		  ...
  		  class Vertex {
  		      ...
  		      getAttribute(name) {
  		          ...
  		          sharedExports.Data.assert(attribute !== undefined, `Vertex does not have an attribute named "${name}".`);
  		          return attribute;
  		      }
  		      adheresTo(contract) {
  		      ...
  		      static flatten(vertices, contract) {
  		          ...
  		          for (const vertex of vertices) {
  		              for (const attributeDescriptor of contract) {
  		                  ...
  		                  switch (attributeDescriptor.scalarType) {
  		                      case "float32":
  		                          attribute.components.forEach((value, index) => (view.setFloat32(offset + index * Vertex.getScalarByteLength(attributeDescriptor.scalarType), value, true)));
  		                          break;
  		                      case "integer32":
  		                          attribute.components.forEach((value, index) => (view.setInt32(offset + index * Vertex.getScalarByteLength(attributeDescriptor.scalarType), value, true)));
  		                          break;
  		                      case "unsigned_integer32":
  		                          attribute.components.forEach((value, index) => (view.setUint32(offset + index * Vertex.getScalarByteLength(attributeDescriptor.scalarType), value, true)));
  		                          break;
  		                      default:
  		      ...
  		      static getStride(contract) {
  		          return contract.reduce((stride, attributeDescriptor) => (stride + attributeDescriptor.vectorSize * Vertex.getScalarByteLength(attributeDescriptor.scalarType)), 0);
  		      }
  		      static getScalarByteLength(scalarType) {
  		          switch (scalarType) {
  		              case "float32":
  		              case "integer32":
  		              case "unsigned_integer32":
  		  ...
  		  class WebGpuPipeline extends Pipeline {
  		      renderer;
  		      handle;
  		      constructor(options) {
  		          super(options);
  		          ...
  		          sharedExports.Data.assert(vertexShader !== undefined, "A vertex shader must be supplied to create a valid WebGPU pipeline.");
  		      ...
  		      static getTranslatedScalar(scalar) {
  		  ...
  		  class WebGpuShader extends Shader {
  		      renderer;
  		      handle;
  		      constructor(options) {
  		          super(options);
  		  ...
  		  class WebGpuGraphicsFactory extends GraphicsFactory {
  		      renderer;
  		      ...
  		      createPipeline(options) {
  		          ...
  		          sharedExports.Data.assert(shaders.every((shader) => shader instanceof WebGpuShader), WebGpuGraphicsFactory._createFactoryMismatchMessage(`Invalid shaders. Expected all shaders to be instances of ${WebGpuShader.name}.`));
  		      ...
  		      createMaterial(options) {
  		          ...
  		          sharedExports.Data.assert(pipeline instanceof WebGpuPipeline, WebGpuGraphicsFactory._createFactoryMismatchMessage(`Invalid pipeline. Expected pipeline to be an instance of ${WebGpuPipeline.name}.`));
  		      ...
  		      static _createFactoryMismatchMessage(message) {
  		          return [
  		              message,
  		  ...
  		  class WebGpuRenderer extends Renderer {
  		      ...
  		      async initialize(canvas) {
  		          ...
  		          sharedExports.Data.assert(context !== null, "Failed to get WebGPU rendering context from canvas element.");
  		          const adapter = await this.gpu.requestAdapter();
  		          sharedExports.Data.assert(adapter !== null, "Failed to request WebGPU adapter.");
  		      ...
  		      renderModel(model, instanceCount = 1) {
  		          const encoders = this.encoders;
  		          const pipeline = this.currentPipeline;
  		          if (this.debug) {
  		              sharedExports.Data.assert(model.mesh.adheresTo(pipeline.contract), "Mesh does not adhere to pipeline's vertex attribute contract!");
  		          }
  		          const uniformBindGroupEntry = this.uniformsBindGroups.get(pipeline);
  		          sharedExports.Data.assert(uniformBindGroupEntry !== undefined, `A bind group doesn't exist for the renderer's current pipeline.`);
  		          ...
  		          const near = -1;
  		          const far = 100;
  		          const projectionMatrix = buildExports.Matrix4.orthographic(left, right, bottom, top, near, far);
  		          const viewMatrix = buildExports.Matrix4.identity();
  		          ...
  		          if (model.mesh.indices === undefined) {
  		              ...
  		              sharedExports.Data.assert(indexBuffer !== undefined, `Model had a mesh with indices defined, but lacked an index buffer!`);
  		      ...
  		      get currentPipeline() {
  		          sharedExports.Data.assert(this.pipeline !== undefined, "Attempted to render without a pipeline set. " +
  		              "Did you call render() before setting a pipeline?");
  		          return this.pipeline;
  		      }
  		      get resources() {
  		          sharedExports.Data.assert(this._resources !== undefined, "Attempted to access GPU device before renderer initialization.");
  		          return this._resources;
  		      }
  		      get encoders() {
  		          sharedExports.Data.assert(this.resources.encoders !== undefined, "Attempted to access GPU encoders before they were created. " +
  		  ...
  		  class InstanceManager {
  		       ...
  		       */
  		      static INSTANCE_SIZE = (buildExports.Matrix4.SIZE +
  		          buildExports.Vector4.SIZE);
  		      renderer;
  		      pipeline;
  		      model;
  		      _instances;
  		      ...
  		      constructor(options) {
  		          ...
  		          this._instances = options.instances;
  		          this._data = new Float32Array();
  		          const allocateInstanceCount = options.preallocatedInstanceCount !== undefined && options.preallocatedInstanceCount > this._instances.length ? (options.preallocatedInstanceCount) : (this._instances.length);
  		  ...
  		  class Model {
  		      ...
  		      constructor(options) {
  		          ...
  		          this.transform = options.transform ?? buildExports.Matrix4.identity();
  		  ...
  		  class VertexAttribute extends buildExports.Vector {
  		      name;
  		      constructor(name, source) {
  		          super(...source);
  		          this.name = name;
  		      }
  		      adheresTo(descriptor) {
  		          return (this.name === descriptor.name &&
  ...
  function requireClient () {
  	...
  	(function (module, exports) {
  		(function (global, factory) {
  		  factory(exports, requireShared()) ;
  		})(client, (function (exports, shared) {
  		  function _iterableToArrayLimit(r, l) {
  		    var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"];
  		    if (null != t) {
  		      var e,
  ...
  class StateManager {
      ...
      async change(stateName) {
          ...
          sharedExports.Data.assert(newState !== undefined, `Failed to find state named "${stateName}".`);
  ...
  class Application {
      ...
      constructor(options) {
          ...
          if (typeof options.canvas === "string") {
              ...
              sharedExports.Data.assert(retrievedCanvas !== null, `Failed to find canvas element with ID "${options.canvas}" in DOM.`);
              sharedExports.Data.assert(retrievedCanvas instanceof HTMLCanvasElement, `Expected element with ID "${options.canvas}" to be a ${HTMLCanvasElement.name}, but got a ${retrievedCanvas.constructor.name}.`);
              this.canvas = retrievedCanvas;
          }
          else {
              this.canvas = options.canvas;
          }
          this.clock = new sharedExports.Clock();
          this.assets = new clientExports.AssetManager();
          this.states = new StateManager();
          this.renderer = buildExports$1.createRenderer(options.window, { clearColor: sharedExports.Color.BLACK });
          this._run();
      }
      async _initialize() {
      ...
      async _run() {
          ...
          let lastFrameTime;
          const requestNextFrame = (currentTime) => {
  ...
  class Animator {
      ...
      constructor(sheetSize, spriteSize, animations) {
          this.sheetSize = buildExports.Vector2.from(sheetSize);
          this.spriteSize = buildExports.Vector2.from(spriteSize);
          sharedExports.Data.assert(this.sheetSize.width % this.spriteSize.width === 0, `Sprites of width ${this.spriteSize.width} do not pack nicely into a sprite sheet of width ${this.sheetSize.width}!`);
          sharedExports.Data.assert(this.sheetSize.height % this.spriteSize.height === 0, `Sprites of height ${this.spriteSize.height} do not pack nicely into a sprite sheet of height ${this.sheetSize.height}!`);
          sharedExports.Data.assert(Object.keys(animations).length > 0, `Attempted to create an animator without any animations supplied!`);
          ...
          for (const name in animations) {
              sharedExports.Data.assert(animations[name].first < spriteCount, `First sprite index ${animations[name].first} in "${name}" animation is outside the bounds of the supplied ` +
                  `${this.spriteGrid.width}x${this.spriteGrid.height} sprite sheet! The index of the last sprite in this sheet is ${spriteCount - 1}.`);
              sharedExports.Data.assert(animations[name].last < spriteCount, `Last sprite index ${animations[name].last} in "${name}" animation is outside the bounds of the supplied ` +
                  `${this.spriteGrid.width}x${this.spriteGrid.height} sprite sheet! The index of the last sprite in this sheet is ${spriteCount - 1}.`);
          }
      }
      get spriteIndex() {
